...
def management(start_point, start_time, walking_time_period, walking_speed, bus_waiting_time, bus_ride_time,
    ...
    deegree_wps_url = 'http://127.0.0.1:8080/deegree/services?service=WPS&version=1.0.0&request=execute&identifier='
    ...
    otp_url = deegree_wps_url + 'Walkshed_Transit_Centralized&datainputs=' + otp_dataInputs
    ...
    if walkshed_main != '':
        ...
        if walkshed_json['type'] == "Polygon":
            ...
            transit_url = deegree_wps_url + 'Transit_Centralized&datainputs=' + transit_dataInputs
            ...
            if transit_data != '"NULL"':
                ...
                for item in transit_data_json['features']:
                    ...
                    otp_url = deegree_wps_url + 'Walkshed&datainputs=' + otp_dataInputs
                ...
                union_wps_url = 'http://127.0.0.1:8080/deegree/services'
    ...
    <wps:ResponseForm>
        <wps:ResponseDocument>
            ...
            #invoke poi service
            poi_wps_url = 'http://127.0.0.1:8080/deegree/services'
    ...
    <wps:ResponseForm>
        <wps:ResponseDocument>
            ...
            #invoke crime wps
            crime_wps_url = 'http://127.0.0.1:8080/deegree/services'
    ...
    <wps:ResponseForm>
        <wps:ResponseDocument>
            ...
            #As the volume of input data is too large for HTTP GET request, HTTP POST is used to invoke deegree Aggregation WPS

            aggregation_wps_url = 'http://127.0.0.1:8080/deegree/services'
